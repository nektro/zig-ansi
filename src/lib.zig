...
pub const csi = struct {
    pub fn CursorUp(comptime n: i32) []const u8 { return make_csi_sequence("A", .{n}); }
    pub fn CursorDown(comptime n: i32) []const u8 { return make_csi_sequence("B", .{n}); }
    pub fn CursorForward(comptime n: i32) []const u8 { return make_csi_sequence("C", .{n}); }
    pub fn CursorBack(comptime n: i32) []const u8 { return make_csi_sequence("D", .{n}); }
    pub fn CursorNextLine(comptime n: i32) []const u8 { return make_csi_sequence("E", .{n}); }
    pub fn CursorPrevLine(comptime n: i32) []const u8 { return make_csi_sequence("F", .{n}); }
    pub fn CursorHorzAbs(comptime n: i32) []const u8 { return make_csi_sequence("G", .{n}); }
    pub fn CursorPos(comptime n: i32, m: i32) []const u8 { return make_csi_sequence("H", .{n, m}); }
    pub fn EraseInDisplay(comptime n: i32) []const u8 { return make_csi_sequence("J", .{n}); }
    pub fn EraseInLine(comptime n: i32) []const u8 { return make_csi_sequence("K", .{n}); }
    pub fn ScrollUp(comptime n: i32) []const u8 { return make_csi_sequence("S", .{n}); }
    pub fn ScrollDown(comptime n: i32) []const u8 { return make_csi_sequence("T", .{n}); }
    pub fn HorzVertPos(comptime n: i32, m: i32) []const u8 { return make_csi_sequence("f", .{n, m}); }
    pub fn SGR(comptime ns: anytype) []const u8 { return make_csi_sequence("m", ns); }
};
